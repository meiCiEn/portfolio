        ...
        <div class="breadcrumb__wrapper breadcrumb__wrapper--contact">
            ...
            <nav class="breadcrumb" aria-label="Breadcrumb">
                <ul class="breadcrumb__list">
                    ...
                    <li class="breadcrumb__item"><a class="breadcrumb__link" href="?section=contact" aria-current="location">Contact</a></li>
                </ul>
            </nav>
            <a class="back back--contact" href="?section=home"><svg id="back" class="back" xmlns="http://www.w3.org/2000/svg" width="50.06" height="50" viewBox="0 0 50.06 50">
                    <g id="About_offwhite">
            ...
            <div class="contact__wrapper">
                <div class="contact">
                    <div class="wrapper wrapper--contact">
                        <!--?xml version="1.0" encoding="UTF-8"?--><svg id="contact" xmlns="http://www.w3.org/2000/svg" width="577.1699829101562" height="72" viewBox="0 0 577.17 72">
                            <defs>
                                <style>
                                    .cls-1 {
                                        fill: #265e5d;
                        ...
                        <!--?xml version="1.0" encoding="UTF-8"?--><svg id="contact-sm" xmlns="http://www.w3.org/2000/svg" width="376.4599914550781" height="166.27999877929688" viewBox="0 0 376.46 166.28">
                            <defs>
                                <style>
                                    .cls-1 {
                                        fill: #265e5d;
                            ...
                            <g id="Connect">
                                <g>
                                    ...
                                    <g>
                                        <path class="cls-1 svg-elem-5" d="M1,141.38v-22.33c0-14.19,10.13-23.76,25.24-23.76s25.15,9.57,25.15,24.09v5.27h-8.55v-5.27c0-9.71-6.7-16.46-16.6-16.46s-16.6,6.75-16.6,16.78v21.13c0,10.08,6.66,16.83,16.6,16.83s16.6-6.75,16.6-16.55v-5.18h8.55v5.18c0,14.61-10.08,24.18-25.15,24.18S1,155.71,1,141.38Zm56.5-30.84c0-8.97,6.66-15.03,16.6-15.03s16.46,6.06,16.46,15.03v12.76c0,8.97-6.61,15.03-16.46,15.03s-16.6-6.06-16.6-15.03v-12.76Zm16.6,21.04c5.32,0,8.83-3.56,8.83-8.78v-11.65c0-5.27-3.51-8.78-8.83-8.78s-8.97,3.47-8.97,8.78v11.65c0,5.32,3.61,8.78,8.97,8.78Zm0,15.33c3.05,0,5.64,2.5,5.64,5.55,0,3.24-2.59,5.69-5.64,5.69s-5.73-2.45-5.73-5.69c0-3.05,2.59-5.55,5.73-5.55Z"></path>
                                        <path class="cls-1 svg-elem-6" d="M98.51,95.28h8.51l25.11,14.56c2.82,1.66,4.85,.32,4.85-2.91v-11.65h8.65v.05l25.01,14.52c2.82,1.66,4.85,.32,4.85-2.91v-11.65h8.65v67.78h-8.65v-37.91c0-2.22-.88-3.7-2.82-4.85l-22.19-12.9c-2.82-1.62-4.85-.32-4.85,2.91v52.75h-8.65v-37.91c0-2.22-.88-3.7-2.82-4.85l-22.19-12.9c-2.82-1.62-4.85-.32-4.85,2.91v52.75h-8.6V95.28Z"></path>
                                        <path class="cls-1 svg-elem-7" d="M195,95.28h42.68v7.31h-30.33c-2.27,0-3.75,1.29-3.75,3.33v6.2c0,2.08,1.48,3.47,3.75,3.47h30.33v7.31h-30.01c-2.45,0-4.07,1.62-4.07,4.11v24.69c0,2.45,1.62,4.07,4.07,4.07h30.01v7.31h-42.68V95.28Z"></path>
                                        <path class="cls-1 svg-elem-8" d="M246.84,141.38v-22.33c0-14.19,10.13-23.76,25.24-23.76s25.15,9.57,25.15,24.09v5.27h-8.55v-5.27c0-9.71-6.7-16.46-16.6-16.46s-16.6,6.75-16.6,16.78v21.13c0,10.08,6.66,16.83,16.6,16.83s16.6-6.75,16.6-16.55v-5.18h8.55v5.18c0,14.61-10.08,24.18-25.15,24.18s-25.24-9.57-25.24-23.9Z"></path>
                                        <path class="cls-1 svg-elem-9" d="M316.41,102.58h-14.56v-7.31h46.7v7.31h-14.93c-2.36,0-4.16,1.71-4.16,4.16v56.31h-8.55v-56.04c0-2.59-1.85-4.44-4.48-4.44Z"></path>
                                        <path class="cls-1 svg-elem-10" d="M364.08,158.34c0-3.05,2.59-5.55,5.73-5.55s5.64,2.5,5.64,5.55c0,3.24-2.64,5.69-5.64,5.69s-5.73-2.45-5.73-5.69Zm10.17-63.06l-.42,50.26h-8.18l-.42-50.26h9.02Z"></path>
                                        <g>
                                            <path class="cls-1 svg-elem-11" d="M277.4,132.83c.05,1.7-3.77,14.91-4.17,16.85h-4.99c.79-3.78,3.95-10.33-.12-13.22-5.98-7.7,8.47-13.22,9.28-3.63Z"></path>
                                            <path class="cls-1 svg-elem-12" d="M277.36,116.23c0,2.91-2.36,5.32-5.22,5.32-3.05,0-5.41-2.41-5.41-5.32s2.36-5.36,5.41-5.36c2.86,0,5.22,2.35,5.22,5.36Z"></path>
                                        </g>
                                    </g>
                                </g>
                            </g>
                    ...
                    <div class="contact__content">
                        <section class="contact__details">
                            <p>Get in touch with me through social media or using the contact form.
  ...
  method="POST">
                                ...
                                <form id="fs-frm" name="simple-contact-form" accept-charset="utf-8" action="https://formspree.io/f/xqkoqqdw" method="post">
                                    <fieldset id="fs-frm-inputs">
                                        ...
                                        <textarea rows="5" name="message" id="message" placeholder="What would you like to discuss?" required=""></textarea>
                                        <input type="hidden" name="_subject" id="email-subject" value="Contact Form Submission">
                                    </fieldset>
                                    <input class="button__body button__body--form" type="submit" value="Submit">
                                </form>
