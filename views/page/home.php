        ...
        <div class="intro__text">
            <div class="intro__text-wrapper">
                <div class="wrapper wrapper--eleanor">
                    <svg id="eleanor" xmlns="http://www.w3.org/2000/svg" width="616.0800170898438" height="72" viewBox="0 0 616.08 72">
                        ...
                        <g id="Eleanor_green">
                            <g>
                                ...
                                <path id="L" class="cls-1 svg-elem-2 letter even" d="M99.4,63.56v7.44H56.41V1.89h8.77V59.4c0,2.6,1.56,4.16,4.14,4.16h30.07Z"></path>
                    ...
                    <!--?xml version="1.0" encoding="UTF-8"?--><svg id="EleanorMears" xmlns="http://www.w3.org/2000/svg" width="353.0299987792969" height="167.74000549316406" viewBox="0 0 353.03 167.74">
                        <defs>
                            <style>
                                .cls-1 {
                                    fill: #265e5d;
...
mouseTrail.appendChild(innerCircle);

document.addEventListener('mousemove', (e) => {
    const x = e.clientX - mouseTrail.offsetLeft;
    const y = e.clientY - mouseTrail.offsetTop;
    innerCircle.style.transform = `translate(${x}px, ${y}px)`;
});

mouseTrail.addEventListener('mouseenter', () => {
    innerCircle.classList.add('invert-colors');
});

mouseTrail.addEventListener('mouseleave', () => {
    innerCircle.classList.remove('invert-colors');
});
