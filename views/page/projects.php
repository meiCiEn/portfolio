                                ...
                                <a class="projects__link" href="?section=project-molenbeek">
                                    <div class="projects__row">
                                        <div class="projects__name italic">
                                            ...
                                            <h4 class="projects__title uppercase">Mole&#x0272;beek en Prome&#x0272;ade</h4>
                                        </div>
                                ...
                                <a class="projects__link" href="?section=project-ecologie">
                                    <div class="projects__row">
                                        <div class="projects__name italic">
                                            ...
                                            <h4 class="projects__title uppercase">Maiso&#x0272; de l'Écologie</h4>
                                        </div>
                                        <div class="projects__year">
                                ...
                                <a class="projects__link" href="?section=project-bwt">
                                    <div class="projects__row">
                                        <div class="projects__name italic">
                                            ...
                                            <h4 class="projects__title uppercase">Belgium Wome&#x0272; Together</h4>
                                        </div>
                                        <div class="projects__year">
                                ...
                                <a class="projects__link" href="?section=project-bakery">
                                    <div class="projects__row">
                                        <div class="projects__name italic">
                                            ...
                                            <h4 class="projects__title uppercase">Boulangerie</h4>
                                        </div>
                                        <div class="projects__year">
                                            <p class="projects-year">2022</p>
                                        </div>
